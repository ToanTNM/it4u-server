...
class It4uApplicationTests {
	...
	//    wait.until(ElemtDisappear("//li//div//span[contains(text(),'Dashboard')]"));
		WebElement clickDashboard = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li//div//i[@class='anticon anticon-dashboard']")));
		clickDashboard.click();
		WebElement clickDashboard1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li//a//span[contains(text(),'Dashboard 1')]/..")));
