...
public class ChannelInfoService {
	...
	public List<ChannelAttribute> findChannelAttributeByDate(Timestamp fromDate, Timestamp toDate) {
		List<ChannelAttribute> listChannelAttribute = channelAttributeRepository.findChannelAttributes(fromDate,
				toDate);
	...
	public boolean updateInfoChannelDetail(long channelDetailId, JSONObject updatingChannelDetail) {
		...
		channelDetail.setRouterType(
				updatingChannelDetail.getString("routerType").isNullorEmpty() ? channelDetail.getRouterType()
						: updatingChannelDetail.getString("routerType"));
		channelDetail.setDeviceStatus(
				updatingChannelDetail.getString("deviceStatus").isNullorEmpty() ? channelDetail.getDeviceStatus()
						: updatingChannelDetail.getString("deviceStatus"));
		...
		ChannelValue channelValue = channelValueRepository
				.findByServicePack(updatingChannelDetail.getString("servicePack"));
