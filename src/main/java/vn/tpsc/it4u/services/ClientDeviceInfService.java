...
import vn.tpsc.it4u.models.ClientDeviceInf;
import vn.tpsc.it4u.models.Contract;
import vn.tpsc.it4u.models.SitesName;
import vn.tpsc.it4u.payloads.ClientDeviceInfSummary;
...
public class ClientDeviceInfService {
	...
	public Boolean uploadClientDeviceInf(JSONObject data, JSONObject infoContract) {
		ClientDeviceInf clientDeviceInf = new ClientDeviceInf(
				...
				data.getString("note"));
		try {
			if (contractRepository.existsByParamContract(infoContract.getString("customId"),
					infoContract.getString("companyName"),
					infoContract.getString("street"), infoContract.getString("contracts"))) {
				Contract contract = contractRepository.findByParamContract(infoContract.getString("customId"),
						infoContract.getString("companyName"),
						infoContract.getString("street"), infoContract.getString("contracts"));
