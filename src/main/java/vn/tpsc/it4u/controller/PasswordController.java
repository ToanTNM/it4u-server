...
import vn.tpsc.it4u.service.EmailService;
import vn.tpsc.it4u.service.ForgotUserService;
...
public class PasswordController {
    ...
    @ApiOperation(value = "Process reset password form")
    @PostMapping("/reset")
    ...
    @ApiOperation(value = "Display form to reset password")
    @GetMapping("/reset")
