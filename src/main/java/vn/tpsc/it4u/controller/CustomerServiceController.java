...
public class CustomerServiceController {
    ...
    @ApiOperation(value = "Create a customer breakdowns")
    ...
    @ApiOperation(value = "List all customer breakdowns")
    ...
    @ApiOperation(value = "List all customer breakdowns from time to time")
    ...
    @ApiOperation(value = "Create a service deployment")
    ...
    @ApiOperation(value = "List all service deployment")
    ...
    @ApiOperation(value = "List all service deployment from time to time")
    ...
    @ApiOperation(value = "Create a customer support")
    ...
    @ApiOperation(value = "List all customer support")
    ...
    @ApiOperation(value = "List all customer support from time to time")
    ...
    @ApiOperation(value = "Create a handle service")
    ...
    @ApiOperation(value = "List all handle services")
    @GetMapping("/it4u/handle/services.all")
    public ResponseEntity<?> listAllHandleServices() {
        return ResponseEntity.ok(customerService.findAllCustomerSupport());
    }

    @ApiOperation(value = "List all handle services from time to time")
    ...
    @ApiOperation(value = "Service statistics by month")
