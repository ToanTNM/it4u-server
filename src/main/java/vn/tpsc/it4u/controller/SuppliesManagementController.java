...
public class SuppliesManagementController {
    ...
    @Operation(description = "Create a list supplies")
    ...
    @Operation(description = "Upload file list supplies")
    ...
    @Operation(description = "Updated a list supplies by id")
    ...
    @Operation(description = "Get a list supplies by id")
    ...
    @Operation(description = "Get all list supplies")
    ...
    @Operation(description = "Delete a list supplies by id")
    ...
    @Operation(description = "Upload file export warehouse")
    ...
    @Operation(description = "Create an export warehouse")
    ...
    @Operation(description = "Update an export warehouse by id")
    ...
    @Operation(description = "Get an export warehouse by id")
    ...
    @Operation(description = "get an export warehouse by mac")
    ...
    @Operation(description = "Get all export warehouse by date")
    ...
    @Operation(description = "Get all export warehouse")
    ...
    @Operation(description = "Delete an export warehouse by id")
    ...
    @Operation(description = "Upload file import warehouse")
    ...
    @Operation(description = "Post an import warehouse")
    ...
    @Operation(description = "update an import warehouse by id")
    ...
    @Operation(description = "Get an import warehouse by id")
    ...
    @Operation(description = "Get all import warehouse by date")
    ...
    @Operation(description = "Get all import warehouse")
    ...
    @Operation(description = "Delete an improt warehouse by id")
    ...
    @Operation(description = "Report supplies")
