...
public interface ContractRepository extends JpaRepository<Contract, Long> {
	...
	Contract findByParamContract(@Param("customId") String customId, @Param("clientName") String clientName,
			@Param("street") String street, @Param("numContract") String numContract);
	...
	@Query(value = "SELECT"
			...
			+ " c.num_contract LIKE :numContract% OR"
			+ " c.custom_id LIKE :customId%", nativeQuery = true)
	Boolean existsByParamContract(@Param("customId") String customId, @Param("clientName") String clientName,
			@Param("street") String street, @Param("numContract") String numContract);
