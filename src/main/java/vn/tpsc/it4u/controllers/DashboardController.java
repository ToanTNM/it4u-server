...
public class DashboardController {
	...
	@Operation(description = "Cookies IT4U")
	...
	@Operation(description = "Post cookies ubnt")
	...
	@Operation(description = "Check cookies ubnt")
	...
	public ResponseEntity<?> checkCookiesUbnt(Locale locale) {
		...
		try {
			...
			return ResponseEntity
					.ok(apiResponse.success("csrfToken: " + arrToken[1] + ";" + "unifises" + arrUnifise[1], locale));
		}
	}

	@Operation(description = "Get cookies ubnt")
	...
	@Operation(description = "Cookies Zabbix")
	@GetMapping("/it4u/cookiesZabbix")
	public String getCookiesZabbix() {
		ApiRequest apiRequest = new ApiRequest();
		String dataPostZabbix = "{\"jsonrpc\": \"2.0\",\"method\": \"user.login\",\"params\": {\"user\": \""
				+ usernameZabbix + "\",\"password\": \"" + passwordZabbix + "\"},\"id\": 1}";
	...
	// Register sitesname
	@Operation(description = "Create sites name request")
	...
	@Operation(description = "Client Essid")
	...
	@Operation(description = "Current client usage")
	...
	@Operation(description = "Get mac AP")
	...
	@Operation(description = "Current traffic usage")
	...
	@Operation(description = "Per radio type")
	...
	@Operation(description = "Quick look")
	...
	@Operation(description = "Hourly Client")
	...
	public String getHourlyClient(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		ApiRequest apiRequest = new ApiRequest();
		// String getMinute = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
		// "/stat/report/5minutes.site/",csrfToken,unifises,postData);
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/hourly.site/", csrfToken,
				unifises, postData);
	...
	@Operation(description = "5 minutes Client")
	...
	@Operation(description = "Daily Client")
	...
	public String getDailyClient(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		// String getMinute = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
		// "/stat/report/5minutes.site/",csrfToken,unifises,postData);
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/daily.site/", csrfToken,
				unifises, postData);
		JSONObject getData = new JSONObject(getHourly);
		JSONArray dataHourly = getData.getJSONArray("data");
		JSONObject getPosZero = (JSONObject) dataHourly.get(0);
	...
	@Operation(description = "Daily AP")
	...
	public String getDailyAP(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		// String getMinute = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
		// "/stat/report/5minutes.site/",csrfToken,unifises,postData);
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/daily.ap/", csrfToken,
				unifises, postData);
		JSONObject getData = new JSONObject(getHourly);
		JSONArray dataHourly = getData.getJSONArray("data");
		JSONObject getPosZero = (JSONObject) dataHourly.get(0);
	...
	@Operation(description = "Hourly AP")
	...
	public String getHourlyAP(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		// String getMinute = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
		// "/stat/report/5minutes.site/",csrfToken,unifises,postData);
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/hourly.ap/", csrfToken,
				unifises, postData);
		JSONObject getData = new JSONObject(getHourly);
		JSONArray dataHourly = getData.getJSONArray("data");
		JSONObject getPosZero = (JSONObject) dataHourly.get(0);
	...
	@Operation(description = "5 minutes AP")
	...
	public String get5MinutesAP(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		// String getMinute = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
		// "/stat/report/5minutes.site/",csrfToken,unifises,postData);
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/5minutes.ap/", csrfToken,
				unifises, postData);
		JSONObject getData = new JSONObject(getHourly);
		JSONArray dataHourly = getData.getJSONArray("data");
		JSONObject getPosZero = (JSONObject) dataHourly.get(0);
	...
	@Operation(description = "Get time hourly")
	...
	@Operation(description = "Get time 5 minutes")
	...
	public String getTimeMinute(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		int k = 0;
		ApiRequest apiRequest = new ApiRequest();
		String getHourly = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/stat/report/5minutes.site/", csrfToken,
				unifises, postData);
		JSONObject getData = new JSONObject(getHourly);
		JSONArray dataHourly = getData.getJSONArray("data");
		JSONObject getPos = (JSONObject) dataHourly.get(0);
	...
	@Operation(description = "Get time daily")
	...
	@Operation(description = "Count AP Connect")
	...
	@Operation(description = "Hotspot")
	@PostMapping("it4u/{id}/hotspot/{start}/{end}")
	public String getHotspot(@PathVariable(value = "id") String userId, @PathVariable(value = "start") String start,
			@PathVariable(value = "end") String end, @RequestBody String postData,
			@CurrentUser CustomUserDetails currentUser) {
		DashboardController dashboard = new DashboardController();
		JSONObject conditionGetData = new JSONObject(dashboard.conditionGetData(userId, currentUser));
		if (conditionGetData.getInt("dk") == conditionGetData.getInt("length")) {
		...
		JSONObject getPostData = new JSONObject(postData);
		ApiRequest apiRequest = new ApiRequest();
		String getData = apiRequest.getRequestApi(urlIt4u, "/s/" + userId + "/stat/guest?start=" + start + "&end=" + end,
				csrfToken, unifises);
		JSONObject jsonResult = new JSONObject(getData);
		JSONArray data = jsonResult.getJSONArray("data");
		for (int i = 0; i < data.length(); i++) {
	...
	@Operation(description = "View detail hotspot")
	...
	// Dashboard 2
	@Operation(description = "Devices info")
	...
	public String getDevicesInfo(@PathVariable(value = "id") String siteName) {
		...
		for (int i = 1; i < 6; i++) {
			...
			try {
				if (convertDataToJson.getString("wan" + i + "_provider").equals("")
						|| convertDataToJson.getString("wan" + i + "_provider").equals("NONE")) {
					continue;
				} else {
	...
	@Operation(description = "Customer info")
	...
	@Operation(description = "Traffic AP")
	...
	// Get network rates
	@Operation(description = "getNetworkRates")
	...
	// Get traffic history
	@Operation(description = "Get traffic history")
	...
	// get history zabbix
	@Operation(description = "History Network")
	...
	public String getHistoryNetwork(@PathVariable(value = "id") String idUser, @RequestBody String postData,
		...
		String dataPostUpload = "{\"jsonrpc\": \"2.0\",\"method\": \"history.get\",\"params\": {\"output\": \"extend\",\"history\": 0,\"itemids\": \""
				+ itemUploadId + "\",\"time_from\":" + timeFrom + ",\"time_till\":" + timeTill + "},\"auth\": \"" + tokenZabbix
				+ "\",\"id\": 1}";
		String dataPostDownload = "{\"jsonrpc\": \"2.0\",\"method\": \"history.get\",\"params\": {\"output\": \"extend\",\"history\": 0,\"itemids\": \""
				+ itemDownloadId + "\",\"time_from\":" + timeFrom + ",\"time_till\":" + timeTill + "},\"auth\": \""
				+ tokenZabbix + "\",\"id\": 1}";
	...
	@Operation(description = "History Status")
	...
	@Operation(description = "History time status")
	...
	@Operation(description = "Channel Status")
	...
	@Operation(description = "Provider info")
	...
	// Dashboard - Overview
	@Operation(description = "Dashboard overview")
	...
	public String postVoucher(@RequestBody String postData, @PathVariable(value = "id") String userId,
		...
		String dataPostVouchers = "{\"cmd\":\"create-voucher\",\"n\":" + n + ",\"quota\":" + quota
				+ ",\"expire\":" + expire + ",\"expire_number\":" + expire_number + ",\"expire_unit\":" + expire_unit
				+ ",\"down\":" + down + ",\"up\":" + up + ",\"bytes\":" + bytes + ",\"note\":\"Note Ok\"}";
		String postVoucher = apiRequest.postRequestApi(urlIt4u, "/s/" + userId + "/cmd/hotspot", csrfToken, unifises,
				dataPostVouchers);
		return postVoucher;
	}

	@Operation(description = "Get Voucher")
	...
	@Operation(description = "Get voucher app")
	...
	@Operation(description = "Print Voucher")
	...
	// Update V2
	@Operation(description = "Stat device")
