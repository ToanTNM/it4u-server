...
// public String postVoucher(@RequestBody String postData,@PathVariable(value =
// "id") String userId) {
// ApiRequest apiRequest = new ApiRequest();
// DashboardController dashboardController = new DashboardController();
// String csrfToken = dashboardController.csrfToken;
// String unifises = dashboardController.unifises;
// String postVoucher = apiRequest.postRequestApi(urlIt4u,"/s/" + userId +
// "/cmd/hotspot",csrfToken,unifises,postData);
// return postVoucher;
// }
...
// String getRequest = apiRequest.getRequestApi(urlIt4u,"/s/" + userId +
// "/stat/voucher",csrfToken,unifises);
...
// public String deleteVoucher(@PathVariable(value = "id") String userId,
// @RequestBody String postData) {
// ApiRequest apiRequest = new ApiRequest();
// String getData = apiRequest.postRequestApi(urlIt4u, "/s/" + userId +
// "/cmd/hotspot",csrfToken,unifises,postData);
// return getData;
// }
...
// ApiRequest apiRequest = new ApiRequest();
// String getData = apiRequest.getRequestApi(printUrlVoucher, "/" + userId +
// "?id=" + idVoucher,csrfToken,unifises);
// return getData;
// }
// }
