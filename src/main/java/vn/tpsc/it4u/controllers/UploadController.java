...
public class UploadController {
    ...
    @Operation(description = "Get images")
    @GetMapping("/images/{id}/{typePreview}/{name}")
    public void hotspotImage(@PathVariable(value = "id") String id,
            @PathVariable(value = "typePreview") String typePreview, HttpServletResponse response)
            throws IOException {
    ...
    @Operation(description = "Get config.properties")
    ...
    @Operation(description = "Get index.html file")
    ...
    @Operation(description = "Upload index.html file")
    @PostMapping("/uploadHotspot/index/{id}")
    public ResponseEntity<?> uploadHotspotIndexFile(@PathVariable(value = "id") String id,
    ...
    @Operation(description = "Get home.html file")
    ...
    @Operation(description = "Upload home.html file")
    ...
    @Operation(description = "Upload mobile image")
    ...
    public ResponseEntity<?> uploadMobileImage(@PathVariable(value = "id") String id, @RequestParam MultipartFile file,
        ...
        System.out.println("Product Image Deleted !!!");
        Files.copy(inputStream, Paths.get(path + id + "/" + imagePath + mobileName),
                StandardCopyOption.REPLACE_EXISTING);
        return ResponseEntity.ok(apiResponse.success(1001, locale));
    }

    @Operation(description = "Upload desktop image")
    ...
    public ResponseEntity<?> uploadDesktopImage(@PathVariable(value = "id") String id, @RequestParam MultipartFile file,
        ...
        System.out.println("Product Image Deleted !!!");
        Files.copy(inputStream, Paths.get(path + id + "/" + imagePath + desktopName),
                StandardCopyOption.REPLACE_EXISTING);
        return ResponseEntity.ok(apiResponse.success(1001, locale));
    }
