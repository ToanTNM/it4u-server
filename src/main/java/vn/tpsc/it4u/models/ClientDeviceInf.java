...
public class ClientDeviceInf extends UserDateAudit {
	...
	public ClientDeviceInf(String backup, String maintenance, String ispWan1, String modelWan1, String ipWan1,
			String passWan1,
			String ispWan2, String modelWan2, String ipWan2, String passWan2, String ispWan3, String modelWan3,
			String ipWan3, String passWan3,
			String ispWan4, String modelWan4, String ipWan4, String passWan4, String modelLb, String ipLb,
			String passLb, String modelOther, String ipOther, String passOther,
			String reboot, String monitor, String method, String location, String openPort, String firmware,
			String wanGroup, String note) {
		this.backup = backup;
